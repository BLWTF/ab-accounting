...
Route::group([
    ...
    Route::group(['prefix' => 'double-entry'], function () {
        ...
        Route::post('chart_of_accounts/import', 'ChartOfAccounts@import')->name('chart-of-accounts.import');
        Route::get('chart_of_accounts/export', 'ChartOfAccounts@export')->name('chart-of-accounts.export');

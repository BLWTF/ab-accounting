...
@section('content')
    ...
    <div class="card">
        {!! Form::model($journal, [
            'method' => 'PATCH',
            'id' => 'journal-entry',
            'route' => ['journal-entry.update', $journal->id],
        ...
        <div class="card-body">
            <div class="row">
                {{ Form::dateGroup('paid_at', trans('general.date'), 'calendar', ['id' => 'paid_at', 'class' => 'form-control datepicker', 'required' => 'required', 'date-format' => 'Y-m-d', 'autocomplete' => 'off'], $journal->paid_at) }}

                {{ Form::textGroup('reference', trans('general.reference'), 'file-text-o', []) }}

                {{ Form::textareaGroup('description', trans('general.description'), '', $journal->description, ['rows' => '3', 'required' => 'required']) }}
                    ...
                    <div class="table-responsive">
                        ...
                        <tr class="row" id="tr-subtotal">
                                ...
                                <td class="text-right col-md-4">
                                    ...
                                    <span id="debit-sub" v-if="sub.debit" v-html="sub.debit_formatted"></span>
                                ...
                                <td class="text-right col-md-4">
                                    ...
                                    <span id="credit-sub" v-if="sub.credit" v-html="sub.credit_formatted"></span>
                                    <span v-else>@money(0, $currency->code, true)</span>
                                </td>
                            </tr>
                            ...
                            <tr class="row">
                                ...
                                <td class="text-right col-md-4" :style="{ background: color.debit}">
                                    ...
                                    <span id="debit-total" v-if="total.debit" v-html="total.debit_formatted"></span>
                                    <span v-else>@money(0, $currency->code, true)</span>
                                </td>
                                <td class="text-right col-md-4" :style="{ background: color.credit}">
                                    ...
                                    <span id="credit-total" v-if="total.credit" v-html="total.credit_formatted"></span>
                                    <span v-else>@money(0, $currency->code, true)</span>
                                </td>
                            </tr>
...
@push('scripts_start')
    ...
    <script type="text/javascript">
        var journal_items = {!! json_encode($journal->ledger()->get()) !!};
    </script>
